    ...
    <div class="preview-card">
      <div class="preview-header">
        ...
        <div style="font-size: 12px; color: #94A3B8;">
          Graphic Wordmark & Wave Images · Centered Layout
        </div>
      </div>
    ...
    <div class="sidebar">
      <div class="side-card">
        ...
        <ol class="steps-list">
          ...
          <li>The header logo, wordmark image, and centered layout will appear instantly!</li>
...
print('Updated preview.html without theme switcher!')
